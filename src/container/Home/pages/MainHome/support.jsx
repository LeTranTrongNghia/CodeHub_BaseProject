    ...
    return (
        <div className="flex min-h-screen w-full flex-col">
            ...
            <div className="relative flex w-full min-h-svh items-center justify-center">
                <div
                    className="px-4 py-5 sm:p-6 bg-background border rounded-xl overflow-hidden -mt-36"
                >
                    <div className="flex flex-col gap-y-5 w-full max-w-sm">
                        <div className="space-y-3">
                            ...
                            <p className="text-sm text-muted-foreground">
                                <p>
                                    <a href="/" className="underline text-black">CodeHub</a> is all
                                    about empowering you to learn and create with AI. Feel free to
                                    reach out with any questions, feedback, or collaboration
                                    ideas!
                                </p>
                            </p>
                        </div>

                        <form onSubmit={handleSubmit} className="flex flex-col items-start w-full gap-y-2">
