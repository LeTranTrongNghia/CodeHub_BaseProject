				...
				<Tabs defaultValue='all'>
						...
						<div className='ml-auto flex items-center gap-2'>
							...
							<Dialog>
								<DialogTrigger asChild>
									<Button size='xl' className='h-10 w-32 p-4 gap-1'>
					...
					<TabsContent value='all'>
						<Card x-chunk='dashboard-06-chunk-0'>
							<CardHeader>
								<h1 className='text-white text-3xl font-medium'>Lectures</h1>
								<CardDescription>
            ...
            <Tabs defaultValue="all">
                ...
                <TabsContent value="all">
                    <Card x-chunk="dashboard-06-chunk-0">
                        <CardHeader>
                            ...
                            <CardDescription>
                                <h1 className=" text-sm font-medium">
                                    Level up your coding abilities! Explore Lectures designed for all skill sets, from beginner to advanced.
                                </h1>
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                        ...
                        <CardFooter>
                            <div className="text-xs text-muted-foreground">
                                Showing <strong>{lecturesList.length}</strong> of <strong>{lecturesList.length}</strong>{" "}
                                Total Problems
                            </div>
                        </CardFooter>
                    </Card>
