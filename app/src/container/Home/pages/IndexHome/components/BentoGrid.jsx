                ...
                <div class="container max-w-7xl">
                    <div class="relative">
                        <div class="relative z-10 grid grid-cols-6 gap-3">
                            {/* First card */}
                            <div
                                class="relative col-span-full flex overflow-hidden rounded-2xl border bg-background p-8 lg:col-span-2"
                            >
                                <div class="relative m-auto size-fit">
                                    <div class="relative flex h-24 w-56 items-center justify-center">
                                        <svg
                                        ...
                                        <span className='relative text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 font-extrabold text-5xl'>
                                            100%
                                        </span>
                                    </div>

                                    <h2
                                        class="mt-6 text-center font-bold text-3xl md:text-4xl lg:text-[40px]"
                                    >
                                        Customizable
                                    </h2>
                                </div>
                            ...
                            {/* Second card */}
                            <div
                                class="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 sm:col-span-3 lg:col-span-2"
                            >
                                <div>
                                    <div
                                        class="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border before:bg-muted/20 dark:before:border-white/5"
                                    >
                                        <svg
                                            class="m-auto h-fit w-24"
                                            viewBox="0 0 212 143"
                                            fill="none"
                                            xmlns="http://www.w3.org/2000/svg"
                                        >
                                            ...
                                            <defs>
                                                ...
                                                >
                                                    <stop stop-color="purple" stop-opacity="0"></stop>
                                                    <stop
                                                ...
                                                <clip-path id="clip0_0_1">
                                                    <rect
                                                        ...
                                                        height="72"
                                                        fill="white"
                                                        class="fill-indigo-500 opacity-100"
                                                        transform="translate(41)"></rect>
                                                </clip-path>
                                            </defs>
                                        </svg>
                                    </div>
                                    <div class="relative z-10 mt-8 space-y-1.5 text-center">
                                        <h2 class="text-lg font-medium text-foreground">
                                            Secure by default
                                        </h2>
                                        <p class="text-muted-foreground">
                                            Protect your code and data with our secure platform. Focus on learning, not security worries.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            >
                                <div>
                                    <div>
                                        ...
                                        >
                                            ...
                                            <path
                                                ...
                                                fill="url(#paint0_linear_0_106)"></path>
                                            <path
                                                class="text-indigo-600/60"
                                            ...
                                            <defs>
                                                <linearGradient
                                                    ...
                                                    gradientUnits="userSpaceOnUse"
                                                >
                                                    <stop class="text-purple-600/80" stop-color="currentColor"
                                                    ></stop>
                                                    <stop
                                                        class="text-white dark:text-transparent"
                                                        offset="1"
                                                        stop-color="currentColor"
                                                        stop-opacity="0.103775"></stop>
                                                </linearGradient>
                                    ...
                                    <div class="relative z-10 mt-8 space-y-1.5 text-center">
                                        ...
                                        <p class="text-muted-foreground">
                                            Master coding faster with our AI-powered learning tools and instant feedback.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Second row */}
                            <div
                                class="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 lg:col-span-3"
                            >
                                <div class="grid sm:grid-cols-2">
                                    ...
                                    >
                                        <div
                                            class="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:bg-white/5 dark:before:border-white/5 dark:before:bg-white/5"
                                        >
                                            <Rocket class="m-auto size-6"
                                                width="1em"
                                                height="1em"
                                                viewBox="0 0 24 24"
                                            />
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <p class="text-muted-foreground">
                                                Apply your knowledge with hands-on projects and challenges. Get expert feedback and improve your skills.
                                            </p>
                                        </div>
                                    </div>
                                    <div
                                        class="relative -mb-10 -mr-10 mt-8 h-fit rounded-tl-xl border bg-muted/30 pt-6 sm:ml-6 sm:mt-auto"
                                    >
                                        <div class="absolute left-3 top-2 flex gap-1">
                                            <span class="block size-2 rounded-full border border-border"
                                            ></span>
                                            <span class="block size-2 rounded-full border border-border"
                                            ></span>
                                            <span class="block size-2 rounded-full border border-border"
                                        ...
                                        <svg
                                            class="w-full text-indigo-600/60 sm:w-[150%]"
                                            viewBox="0 0 366 231"
                                            fill="none"
                                            xmlns="http://www.w3.org/2000/svg"
                                        >
                                            ...
                                            <defs>
                                                <linearGradient
                                                    ...
                                                    gradientUnits="userSpaceOnUse"
                                                >
                                                    <stop class="text-purple-500/50" stop-color="currentColor"
                                                    ></stop>
                                                    <stop
                                                        class="text-purple-950/5"
                                                        offset="1"
                                                        stop-color="currentColor"
                                                        stop-opacity="0.01"></stop>
                                                </linearGradient>
                                            </defs>
                                        </svg>
                                    </div>
                                ...
                                <div class="grid h-full sm:grid-cols-2">
                                    ...
                                    >
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <p class="text-muted-foreground">
                                                Learn to code from scratch with our interactive courses. Master Python, JavaScript, and more with AI guidance.
                                            </p>
                                        </div>
                                    </div>
                                    <div
                                        class="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-purple-500/50 sm:-my-8 sm:-mr-8"
                                    >
                                        <div
                                        ...
                                        >
                                            ...
                                            >
                                                <span
                                                    class="block h-fit mr-6 rounded-md border bg-muted/50 px-2 py-1 text-xs"
                                                >
                                                    Javascript
                                                </span>
                                            </div>
                                            <div
                                                class="relative ml-[calc(50%-1rem)] flex items-center gap-2"
                                            >
                                                <span
                                                    class="block h-fit ml-6 rounded-md border bg-muted/50 px-2 py-1 text-xs"
                                                >
                                                    Python
                                                </span>
                                            </div>
