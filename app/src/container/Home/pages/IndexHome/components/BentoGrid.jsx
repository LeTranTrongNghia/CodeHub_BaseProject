...
const BentoGrid = () => {
	...
	console.log('In view:', inView); // Debugging line to check if inView is changing
							...
							<div className='relative col-span-full flex overflow-hidden rounded-2xl border bg-background p-8 lg:col-span-2'>
								<div className='relative m-auto size-fit'>
									...
									<motion.h2
										...
										className='mt-6 text-center font-bold text-3xl md:text-4xl lg:text-[40px]'
									>
										Customizable
									</motion.h2>
								</div>
									...
									<div className='relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border before:bg-muted/20 dark:before:border-white/5'>
										...
										>
											...
											<defs>
												...
												>
													<stop stopColor='purple' stopOpacity='0'></stop>
													<stop
								...
								<div>
									...
									<div className='relative z-10 mt-8 space-y-1.5 text-center'>
										<motion.h2
											...
											variants={animate}
											initial="initial"
											animate={inView ? "visible" : "initial"} // Trigger animation on scroll into view
											className='text-lg font-medium text-foreground'
										>
									...
									<div className='relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-purple-500/50 sm:-my-8 sm:-mr-8'>
										<div className='relative flex h-full flex-col justify-center space-y-6 py-6'>
											<div className='relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2'>
												<span className='block h-fit mr-6 rounded-md border bg-muted/50 px-2 py-1 text-xs'>
													Javascript
												</span>
											</div>
											<div className='relative ml-[calc(50%-1rem)] flex items-center gap-2'>
												<span className='block h-fit ml-6 rounded-md border bg-muted/50 px-2 py-1 text-xs'>
													Python
												</span>
											</div>
											<div className='relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2'>
