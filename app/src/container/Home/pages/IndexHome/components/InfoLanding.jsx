...
const InfoLanding = () => {
    return (
        <div className="py-16 sm:py-20">
            <div
                className="mx-auto grid max-w-7xl gap-10 px-4 sm:gap-16 sm:px-6 lg:grid-cols-2 lg:items-center lg:px-8"
            >
                <div className="lg:order-2">
                    <h2
                        className="font-bold text-3xl text-foreground md:text-4xl lg:text-[40px]"
                    >
                        Master Coding, Faster
                    </h2>
                    <p className="mt-6 text-lg text-muted-foreground">
                        Unlock your full coding potential with our AI-powered platform. Learn at your own pace, master new skills, and build amazing projects.
                    </p>
                    <dl className="mt-6 space-y-4 leading-7">
                        <div className="relative pl-8">
                            <dt className="font-semibold">
                                <Activity
                                    className="absolute left-0 top-1 size-5 stroke-purple-700"
                                />
                                <span>Track Your Progress</span>
                            </dt>
                            <dd className="text-sm text-muted-foreground">
                                Stay motivated with detailed learning analytics and time management tools.
                            </dd>
                        </div>
                        <div className="relative pl-8">
                            <dt className="font-semibold">
                            ...
                            <dd className="text-sm text-muted-foreground">
                                Dive into interactive lessons, practice with quizzes, and get expert feedback from our AI tutor.
                            </dd>
                        </div>
                        <div className="relative pl-8">
                            <dt className="font-semibold">
                            ...
                            <dd className="text-sm text-muted-foreground">
                                Solve coding problems, get hints from our AI, and improve your problem-solving skills.
                            </dd>
                        </div>
                    </dl>
                </div>
                <div class="rounded-xl overflow-hidden border lg:-m-4 ">
