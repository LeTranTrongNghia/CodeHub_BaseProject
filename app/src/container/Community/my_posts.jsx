...
import { ArrowRight, Briefcase, Share, Star, Search, Timer, Flame, ChevronLeft, User } from 'lucide-react';
                        ...
                        <div className="px-8 pb-8">
                            <div className="flex flex-col md:flex-row md:items-end mb-8 gap-4">
                                ...
                                <div className="md:text-right mt-4 md:mt-0">
                                    ...
                                    <p className="font-medium text-lg">{userData?.position || "position"}</p>
                                </div>
                            </div>
                            ...
                            <div className="mb-8">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {(userData?.skills || ["HTML", "CSS", "JavaScript"]).map((skill) => (
                                        <span
                                            key={skill}
