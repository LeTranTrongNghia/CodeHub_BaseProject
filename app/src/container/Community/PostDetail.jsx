...
export default function PostDetail() {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground">
            <HeaderCommunity />
            <div className='flex'>
                <main className="flex-1 px-14 py-6 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 64px)' }}>
                            ...
                            <Card key={index}>
                                <CardContent className="p-4">
                                    <div className="flex items-start space-x-4">
                                        <Avatar>
                                            <AvatarImage
                                                src={comment ? comment.avatar : "https://via.placeholder.com/150"}
                                                alt="User"
                                            />
                                            <AvatarFallback>{comment ? comment.username[0] : 'U'}</AvatarFallback>
                                        </Avatar>
                                        <div className="flex-1">
                                            <div className="flex items-center space-x-2">
