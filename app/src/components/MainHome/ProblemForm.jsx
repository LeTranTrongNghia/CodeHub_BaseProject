      ...
      <form onSubmit={onSubmit} className="border rounded-lg overflow-hidden p-4">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-slate-900/10 pb-12 md:grid-cols-2">
          ...
          <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8">
            ...
            <div className="sm:col-span-4">
              <label htmlFor="difficulty" className="block text-sm font-medium leading-6 text-slate-900">
                Difficulty
              </label>
              <div className="mt-2 flex space-x-4">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="easy" className="ml-2 text-sm font-medium leading-6 text-slate-900">
                    Easy
                  </label>
                </div>
                <div className="flex items-center">
                  <input
                    ...
                    onChange={(e) => updateForm({ difficulty: e.target.value })}
                  />
                  <label htmlFor="medium" className="ml-2 text-sm font-medium leading-6 text-slate-900">
                    Medium
                  </label>
                </div>
                <div className="flex items-center">
                  <input
                    ...
                    onChange={(e) => updateForm({ difficulty: e.target.value })}
                  />
                  <label htmlFor="hard" className="ml-2 text-sm font-medium leading-6 text-slate-900">
                    Hard
                  </label>
                </div>
              </div>
            ...
            <div className="sm:col-span-4">
              <label htmlFor="statement" className="block text-sm font-medium leading-6 text-slate-900">
                Statement
              </label>
              <div className="mt-2">
                <textarea
            ...
            <div className="sm:col-span-4">
              <label htmlFor="constraints" className="block text-sm font-medium leading-6 text-slate-900">
                Constraints
              </label>
              <div className="mt-2">
                <textarea
              ...
              <div key={index} className="sm:col-span-4">
                ...
                <div className="mt-2">
                  <textarea
                    ...
                    onChange={(e) => updateTestCase(index, { inputText: e.target.value })}
                  />
                </div>
                <label
                ...
                <div className="mt-2">
                  <textarea
                    ...
                    onChange={(e) => updateTestCase(index, { outputText: e.target.value })}
                  />
                </div>
                <button
                  type="button"
